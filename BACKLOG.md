...
- [ ] юнит тесты на идентити портфеля и инструмента
- [ ] юнит тесты на обработку операций по позициям
- [ ] тесты - забрать операции из гейтвея, преобразовать в доменные, сравнить портфолио
