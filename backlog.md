...
- [ ] Разработать и реализовать новую модель пайплайна
- [ ] Убрать Channel внутри - сделать снаружи
- [ ] Передавать один параметр в пайплайн - евент (сейчас два - евент и сам айтем)
- [ ] Вынести общие BGServices в отдельную сборку и сделать их универсальными
- [ ] Избавиться от инжекта IServiceProvider (в хендлерах реализовать IEnumerable инжект)
- [ ] Проверить работу с бэктестом
