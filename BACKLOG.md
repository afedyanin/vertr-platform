...
- - перевести таблицу свечей в EF Core
- написать скрипт(тесты) по заполнению свечей
- вынести в конфиг настройки предиктора
- поднять в докере предиктор и торговую систему
- дописать readme
