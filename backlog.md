...
- [x] получить из гейтвея трейды
- [x] собирать csv файл со статистикой на выходе
- [x] включить в csv файл трейды по закрытию позиции
- [ ] REST API по управлению торговлей
	- [ ] просмотр позиций и портфелей, вкл. PnL
	- [ ] закрытие позиций 
	- [ ] дамп статистики
	- [ ] останов / перезапуск стратегии (на тех же портфелях или новых?)
- [ ] метрики позиций и потрфеля в прометеус
