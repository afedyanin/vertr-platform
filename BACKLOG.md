...
- написать тесты на имплементацию новых методов тинвест
- проверить правильность маппинга енумов и сущностей
- продумать схему хранения акаунта, портфеля и операций
