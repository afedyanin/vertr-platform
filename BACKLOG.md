...
- маппинг AccountStrategySettings - тесты, использовать в хендлерах через инжект IOptions
- протестировать DAL Trading Signal - мапинг статик классов на сущности БД - переделать на енумы
