...
- [] регресионные тесты
- [] запуск прод версии ml и платформы и контроль работы по логам
- [] подключить старую графану к новомой системе и проверить работу системы
- [] погасить старую систему, удалить акаунт 
- [] вычистить репозиторий vertr-ml от старого кода
