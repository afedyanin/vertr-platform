...
- при сохранении неизмененного объекта вылетает 400 - нужно корректно отрабатывать кейс
- написать юнит тест для бэктеста



# 2025-09-09

## контрол со списком ордер-евентов

- + для бэктеста
- + для стратегии
- + реалтайм апдейты по ордер-евентам
- + выпилить отдельную страцию по ордер-евентам

## общее
- заменить вызов консоль логера тостером, где это применимо
- выводить в нотификации ошибки
- + home page
- убрать заглушку по ограничению позиций или вынести ее в конфиг
- + скрипт первоначальной загрузки данных
- документация по релизу в readme
- + доработать экран выбора инструментов
- сделать активацию подписок без перезапуска приложения
...
- + карточка для бэктеста
- + конфирмация для старта, канцела бэктеста плюс тост
- + обновление в реалтайме для деталей бэктеста
- + добавить ссылку на детали стратегии

## стратегия

- + карточка для стратегии
- + кнопки активации/деактивации стратегии с конфирмацией
- + кнопка сохранения стратегии с тостом


## вычислять в portfolio details ссылки
- +backtestId
- +strategyid
- +реализовать обратные ссылки из портфолио в бэктест / стратегию

## список портфелей
- фильтровать по бэктестам + стратегии
- фильтровать по стратегиям
