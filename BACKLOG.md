...
- Запрашивать Tinvest портфель по необходимости через гейтвей
- Не хранить историю портфеля - ее можно восстанвить по событиям - удалить таблицы с портфелем и позициям
- В order engine убрать вызов Make Snapshot - заменить на GetLast
