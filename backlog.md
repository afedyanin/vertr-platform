...
- [ ] разобраться с QuantityLots в расчете цены и в ордер менеджменте
...
- [ ] притянуть статику по фьючам из MOEX (expDate, lots) сделать IFutureInfoProvider
- [ ] притянуть ставки RUSFAR 
