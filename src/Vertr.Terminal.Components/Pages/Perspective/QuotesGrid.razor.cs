...
namespace Vertr.Terminal.Components.Pages.Perspective;
public partial class QuotesGrid
{
    ...
    protected override async Task OnAfterRenderAsync(bool firstRender)
    {
        if (firstRender)
        {
            ...
            _jsModule = await JSRuntime.InvokeAsync<IJSObjectReference>("import", "./_content/Vertr.Terminal.Components/Pages/Perspective/QuotesGrid.razor.js");
