...
- обработка торговых сингалов от стратегий через выставление и исполнение ордеров
- публикация событий по операциям с торговым счетом (книжкой) - по результатам исполнения ордеров
